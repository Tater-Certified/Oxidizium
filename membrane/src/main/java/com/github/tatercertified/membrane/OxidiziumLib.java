...
@Link
public static native float sin_double(double x);

@Link
public static native float sin_float(float x);

@Link
public static native float cos_float(float x);

@Link
public static native float cos_double(double x);

@Link
public static native float lithium_sin_float(float x);

@Link
public static native float lithium_cos_float(float x);

@Link
public static native float lithium_sin_double(double x);

@Link
public static native float lithium_cos_double(double x);

@Link
public static native float sqrt_float(@PositiveOnly float x);

@Link
public static native int floor_float(float x);

@Link
public static native int floor_double(double x);

@Link
public static native long floor_long(double x);

@Link
public static native float abs_float(float x);

@Link
public static native int abs_int(int x);

@Link
public static native int ceil_float(float x);

@Link
public static native int ceil_double(double x);

@Link
public static native long ceil_long(double x);

@Link
public static native int clamp_int(int x, @Min int min, @Max int max);

@Link
public static native long clamp_long(long x, @Min long min, @Max long max);

@Link
public static native float clamp_float(float x, @Min float min, @Max float max);

@Link
public static native double clamp_double(double x, @Min double min, @Max double max);
...
@Link
public static native float abs_max_float(float i, float j);
...
@Link
public static native int floor_div(int dividend, @NonZero int divisor);
...
@Link
public static native int floor_mod_int(int dividend, @NonZero int divisor);

@Link
public static native float floor_mod_float(float dividend, @NonZero float divisor);

@Link
public static native double floor_mod_double(double dividend, @NonZero double divisor);

@Link
public static native boolean is_multiple_of(int a, @NonZero int b);

@Link
public static native byte pack_degrees(float degrees);

@Link
public static native float unpack_degrees(byte packed_degrees);
...
@Link
public static native int smallest_encompassing_square_side_length(@PositiveOnly int value);
...
@Link
public static native int pack_rgb(float red, float green, float blue);
...
@Link
public static native float inverse_sqrt_float(@PositiveOnly float x);

@Link
public static native double inverse_sqrt_double(@PositiveOnly double x);
...
@Link
public static native int hsv_to_rgb(@PositiveOnly float hue, @PositiveOnly float saturation, @PositiveOnly float value);

@Link
public static native int hsv_to_argb(@PositiveOnly float hue, @PositiveOnly float saturation, @PositiveOnly float value, @PositiveOnly int alpha);
...
@Link
public static native double lerp_3(double delta_x, double delta_y, double delta_z, double x0y0z0, double x1y0z0, double x0y1z0, double x1y1z0, double x0y0z1, double x1y0z1, double x0y1z1, double x1y1z1);
...
@Link
public static native float wrap(float value, float max_deviation);

@Link
public static native float square_float(float value);

@Link
public static native double square_double(double value);

@Link
public static native int square_int(int value);

@Link
public static native long square_long(long value);

@Link
public static native double clamped_map_double(double value, double old_start, double old_end, double new_start, double new_end);

@Link
public static native float clamped_map_float(float value, float old_start, float old_end, float new_start, float new_end);

@Link
public static native double map_double(double value, double old_start, double old_end, double new_start, double new_end);

@Link
public static native float map_float(float value, float old_start, float old_end, float new_start, float new_end);

@Link
public static native int round_up_to_multiple(int value, @NonZero int divisor);

@Link
public static native int ceil_div(int a, @NonZero int b);
...
@Link
public static native float wrap_degrees_90(float angle);

@Link
public static native boolean is_power_of_2(long value);

@Link
public static native long round_towards_long(long input, long multiple);

@Link
public static native int round_towards_int(int input, int multiple);

@Link
public static native long positive_ceil_div_long(long input, long divisor);

@Link
public static native int positive_ceil_div_int(int input, int divisor);
}
